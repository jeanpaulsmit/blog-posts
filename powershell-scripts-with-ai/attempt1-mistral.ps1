...
function Get-ContainerAppScalingDetails {
    ...
    try {
        ...
        $scalingDetails = @{
            ...
            CPU              = $containerApp.Template.Containers.Resources.Cpu
            Memory           = $containerApp.Template.Containers.Resources.Memory
            Replicas         = $containerApp.Template.Scale.MinReplicas
            CustomScalingRules = $containerApp.Template.Scale.Rules
        }
